      ...
      <div className="relative z-10">
        ...
        <div className="container my-8">
          <h3 className="text-foreground text-center uppercase text-lg font-bold mb-4 font-apotek-extended">
            Complete Your Setup With Premium Battery{' '}
            <span className="text-primary">Accessories</span>
          </h3>
        </div>
...
export const metadata: Metadata = {
  title: 'Accessories',
  description: 'Browse our collection of high-quality battery accessories',
  alternates: {
    canonical: `${getServerSideURL()}/products/accessories`,
  },
  openGraph: {
    title: 'Accessories',
    description: 'Browse our collection of high-quality battery accessories',
