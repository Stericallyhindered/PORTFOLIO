...
Software Engineer II / Automation Engineer | Production Tooling | AI/API Integrations | Full Stack & Embedded  
bajaracer415@gmail.com | 415-504-5897 | California, United States  
Portfolio: https://github.com/Stericallyhindered/PORTFOLIO

## Summary

Hands-on software and automation engineer with more than six years of professional experience building production tooling, advanced Airtable automations, internal platforms, API integrations, CI/CD pipelines, AI agents, full-stack applications, and hardware-connected systems. Experienced with Python, C#, Java, Go-style service architecture, TypeScript, cloud platforms, containers, infrastructure-as-code workflows, and reliable automation for live products.

I build the connective tissue between teams and systems: Airtable scripting and APIs, Slack/Signal/WhatsApp automation, Google Workspace and Jira-style integrations, LLM knowledge workflows, internal dashboards, admin portals, cross-project data views, validation tools, background jobs, webhooks, audit trails, and deployment pipelines. I work directly with product managers, producers, designers, engineers, and operations teams to identify friction and own solutions from zero-to-one prototype through tested, documented production operation.

My broader engineering background includes industrial CAD/CAM and machine-control software, cross-platform Flutter applications, embedded C/C++ firmware, bootloaders, Python test automation, BLE/CAN/OBD2/UART communication, high-volume vehicle telemetry, cloud APIs, databases, and regulated analytical systems. This range lets me debug workflow automation across application, infrastructure, data, device, and human-process boundaries.

## Production Tooling Profile

- Own internal automation from workflow discovery and technical strategy through implementation, CI/CD, monitoring, documentation, production support, and handoff.
- Refactor producer- and junior-developer prototypes into maintainable software by defining typed contracts, separating concerns, replacing temporary storage, and adding authentication, authorization, validation, structured logging, tests, deployment configuration, and recovery paths.
- Build directly with product managers, producers, designers, engineers, technicians, support teams, sales, shipping, manufacturing, and business operations; comfortable holding several small-to-medium workstreams in ambiguous environments.
- Led five developers at Burger Motorsports and three junior developers at Stealth while remaining a hands-on architect and primary implementer across automation, full-stack, mobile, firmware, data, AI, and production operations.
- Strong fit for internal tooling, content and data pipelines, developer enablement, cross-team integration, and practical automation where reliability indirectly determines customer or player experience.

## Core Strengths

- Production workflow automation: advanced Airtable bases, scripting, REST API usage, webhooks, linked records, cross-base and cross-project views, Dev/production validation, scheduled and event-driven automations, idempotent processing, reconciliation, and clear failure/retry states.
- Collaboration and enterprise integrations: Slack, Signal, WhatsApp, Google Workspace, Jira, Glean-style knowledge workflows, GitHub, Twilio, email providers, webhooks, OAuth/JWT-style authentication, rate-limit handling, and multi-channel notification and escalation.
- LLM Workstation Hub: channel adapters that normalize Slack, Signal, and WhatsApp events into shared message contracts; route requests through local or hosted models and approved tools; retain authorized history, operational context, and feedback; and return responses or escalate work to the originating channel.
- CI/CD and infrastructure: GitHub-based DevOps workflows, automated build/test/deploy pipelines, Docker and Docker Compose, cloud deployments, environment and secret management, infrastructure-as-code practices, release validation, observability, and production troubleshooting.
...
Software Engineer / AI Engineer / Technical Lead  
May 2025 - Present
...
- Build and maintain advanced Airtable applications for production, product, support, inventory, customer, machine, and cross-project workflows using linked data models, scripts, REST APIs, webhooks, scheduled and event-driven automations, validation, text/data checks, approvals, and synchronized operational views.
- Built the Stealth LLM Workstation Hub integrating Slack, Signal, and WhatsApp through channel adapters, normalized message contracts, local and hosted LLM routing, approved tool execution, persisted conversation and business context, feedback capture, automated responses, and human escalation back to the originating channel.
- Own GitHub-centered DevOps and CI/CD workflows for Stealth software, including automated build, test, and deployment stages, containerized services, environment and secret management, cloud deployments, release validation, logging, monitoring, and production incident troubleshooting.
- Regularly take producer- and junior-developer prototypes from proof of concept to production by restructuring modules, defining typed contracts, replacing temporary data paths, adding permissions, validation, tests, observability, deployment configuration, and operational documentation.
- Work directly across product management, production, design, engineering, sales, support, shipping, manufacturing, and field operations to map workflows, prioritize automation, define requirements, and deliver zero-to-one tools that remove coordination overhead.
...
- Built AI-assisted support and internal workflows combining chat, onboarding, warranty intake, machine/product context retrieval, versioned prompts, tool/API calls, structured validation, confidence thresholds, retained history, analytics, escalation, and role-aware human review.
...
- Connected portals, admin actions, approvals, document intake, notifications, reporting, support history, warranty claims, inventory, shipping/returns, and customer records into structured workflows that reduced manual operational load.
...
- Owned zero-to-one product, producer, design, architecture, implementation, release, and production-support responsibilities while translating requirements from ownership, tuners, support staff, hardware engineering, and customers into dependable software.
- Built private internal dashboards, administrative portals, API services, and automation for vehicle-owner records, support queues, telemetry and datalog analysis, firmware/version context, tuning history, product operations, and high-volume web and data workflows.
...
Automation / Data: Airtable scripting, Airtable REST APIs and automations, linked records, cross-base/project synchronization, Oracle APEX, SQL, PL/SQL-style workflows, Postgres, SQLite, MongoDB/Mongoose, Supabase, Drizzle, Prisma, Redis/BullMQ queues, Payload CMS, migrations, validation, audit trails, and reconciliation  
AI / Integrations: Slack, Signal, WhatsApp, Google Workspace, Jira, Glean-style knowledge integration, Claude/Anthropic, OpenAI and local LLMs, agent tools, prompt/context workflows, retained history, document ingestion, OCR, ticket triage, Stripe, ShipStation/shipping APIs, Resend/Nodemailer, Twilio, and webhooks  
...
DevOps / Ops: GitHub, CI/CD pipelines, Docker and Docker Compose, AWS/GCP/Azure, infrastructure-as-code workflows, automated tests, environment and secret management, logging, monitoring, incident response, C# WinForms, Python/PowerShell automation, and technical documentation
...
I am comfortable with "here is the problem, go figure it out" work. I ask scope questions early, especially around users, safety, diagnostics, edge cases, ownership, and production risk. I prefer simple architecture, clear data flow, validation before control output, and code that another engineer can safely change. I communicate before going dark, leave notes/change logs, and document enough context for the next engineer or AI-assisted workflow to understand the system later.
