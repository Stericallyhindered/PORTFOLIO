...
Full-Stack Software Engineer / Engineering Lead | AI, Mobile, Cloud, Embedded & Hardware Systems  
bajaracer415@gmail.com | 415-504-5897 | California, United States  
Portfolio: https://github.com/Stericallyhindered/PORTFOLIO

## Summary

Hands-on software engineer and engineering lead with more than 11 years of experience building complete systems across full-stack web, AI/agentic workflows, mobile and desktop applications, cloud infrastructure, databases, embedded firmware, industrial machinery, automotive software, ecommerce, analytics, and internal business operations. Experienced with React, Next.js, TypeScript, Node.js, Python, FastAPI, Flutter/Dart, C/C++, C#, Java, SQL, Oracle APEX, PostgreSQL, MongoDB, AWS/cloud services, Docker, CI/CD, and production operations.
...
- Own software systems from workflow discovery and technical strategy through architecture, implementation, CI/CD, monitoring, documentation, production support, and handoff.
...
- Strong fit for full-stack product engineering, mobile applications, AI systems, internal platforms, commerce/admin tooling, hardware-connected software, data pipelines, developer enablement, and production systems where reliability matters.
